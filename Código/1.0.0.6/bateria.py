...
def run_test_suite(MAI_DAI):
    ...
    registros = [500, 10000, 50000, 500000, 1000000]
    padroes = [1]
    itens = [4]
    repeticoes = [7]
    intervalos = [10 ,60, 900, 3600]
...
#     if k==k:
        if k < 10:
            m = f"60dias_{registros}_{padroes}_{itens}_{repeticoes}_{intervalo}_00"+str(k)
            n = f"60dias_{registros}_{padroes}_{itens}_{repeticoes}_{intervalo}_00"+str(k)+".csv"
        elif 10 <= k < 100:
            m = f"60dias_{registros}_{padroes}_{itens}_{repeticoes}_{intervalo}_0"+str(k)
            n = f"60dias_{registros}_{padroes}_{itens}_{repeticoes}_{intervalo}_0"+str(k)+".csv"
        else:
            m = f"60dias_{registros}_{padroes}_{itens}_{repeticoes}_{intervalo}_"+str(k)
            n = f"60dias_{registros}_{padroes}_{itens}_{repeticoes}_{intervalo}_"+str(k)+".csv"
...
#         dbd.main(n, min_repetitions, tempo)
...
#         ar.analyze_data(m, 0, f"Resultado_60dias_{registros}_{padroes}_{itens}_{repeticoes}_{intervalo}.txt")
#       _______________________________________________________________________________
